...
{
    public class CustomerCareIntelligenceWebApiConstant
    {
        
        public const string DashboardAppInsightKey = "d75a7bce-088a-45a2-b6dc-8473a9ebc8aa";

        public const string OlderMonthLabel = "N-2Month";
        public const string PrevMonthLabel = "PrevMonth";
        public const string CurrMonthLabel = "CurrMonth";
        ...
        public const string BIZAI_BUG_CREATE_URL = "https://bizai.visualstudio.com/DefaultCollection/BizAI/_apis/wit/workitems/$Bug?api-version=1.0";

        public const string BIZAI_BUG_CREATE_TEMPLATE = @"[{{""op"": ""add"", ""path"": ""\/fields\/System.Title"", ""value"": ""{0}""}},
                                                           {{""op"": ""add"", ""path"": ""\/fields\/Microsoft.VSTS.TCM.ReproSteps"", ""value"": ""{1}""}}]";
