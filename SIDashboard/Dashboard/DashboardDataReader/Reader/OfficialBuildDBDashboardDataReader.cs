...
{
    public class OfficialBuildDBDashboardDataReader : DBDashboardDataReader
    {
        public OfficialBuildDBDashboardDataReader(string connectionString) : base(connectionString)
        {
        }
        ...
        {
            return ReadSingleColumnTable("prc_GetOfficialBuildDashboard", "FailedBuildCount");            
        }
    }
}