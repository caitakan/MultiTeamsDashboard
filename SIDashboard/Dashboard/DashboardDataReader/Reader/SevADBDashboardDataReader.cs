...
{
    public class SevADBDashboardDataReader : DBDashboardDataReader
    {
        public SevADBDashboardDataReader(string connectionString) : base(connectionString)
        {
        ...
        {
            return ReadSingleColumnTable("prc_GetSevADashboard", "SevA");            
        }
    }
}