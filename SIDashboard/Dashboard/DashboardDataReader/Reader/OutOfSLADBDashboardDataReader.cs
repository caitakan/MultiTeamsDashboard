...
{
    public class OutOfSLADBDashboardDataReader : DBDashboardDataReader
    {
        public OutOfSLADBDashboardDataReader(string connectionString) : base(connectionString)
        {
        ...
        {
            return ReadSingleColumnTable("prc_GetOutOfSLADashboard", "IssueCount");            
        }
    }
}