...
{
    public class CustomerIncidentResolveTimeDBDashboardDataReader : DBDashboardDataReader
    {
        public CustomerIncidentResolveTimeDBDashboardDataReader(string connectionString) : base(connectionString)
        {
        ...
        {
            return ReadSingleColumnTable("prc_GetAverageResolveTime", "AvgResolvedTimeInDays");
        }
    }
}