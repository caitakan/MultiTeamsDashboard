...
{
    public class FunctionTestPassRateDBDashboardDataReader : DBDashboardDataReader
    {
        public FunctionTestPassRateDBDashboardDataReader(string connectionString) : base(connectionString)
        {
        }
        ...
        {
            return ReadSingleColumnTable("prc_GetFunctionTestPassRate", "Passrate");
        }
    }
}