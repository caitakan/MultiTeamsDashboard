...
{
    public class CustomerIncidentDBDashboardDataReader : DBDashboardDataReader
    {
        public CustomerIncidentDBDashboardDataReader(string connectionString) : base(connectionString)
        {
        ...
        {
            return ReadSingleColumnTable("prc_GetIncidentDashboard", "IncidentNum");            
        }
    }
}