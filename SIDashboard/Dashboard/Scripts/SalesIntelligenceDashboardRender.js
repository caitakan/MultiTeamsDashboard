...
$(document).ready(
    function () {
        renderTable(window["SalesIntelligenceDashboardConfig"]);
        ...
        var mapping = {
            ...
            "Mean time to Fix Sev A": "MeanTimeToFixSevA",
            "Mean time to Deploy Sev A": "MeanTimeToDeploySevA",
            "Number of Customers out of SLA": "NumOfCustomersOutOfSLA"
        };
        ...
        $.get('/api/metricsummary?SolutionName=SalesIntelligence', function (response) {
            ...
            setTimeout(
                ...
                window["SalesIntelligenceDashboardRefreshInterval"]);
        }, 'json');
    }
);