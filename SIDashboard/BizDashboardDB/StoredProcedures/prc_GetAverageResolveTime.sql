CREATE PROCEDURE [dbo].[prc_GetAverageResolveTime]
AS
	...
	(
		SELECT SUM ( dbo.GetTimeSpanInDay(CreatedDate, ResolvedDate) ) / SUM( CASE WHEN ResolvedDate IS NOT NULL THEN 1 ELSE 0 END ) AS AvgResolvedTimeInDays
